...
class BaselineModel:
    ...
    @property
    def name(self):
        return "model_kaggle_basepath.pkl"

    def __init__(self, encoder_label, dev=False):
        self.savepath = os.getenv("MODEL_SAVEPATH_BASEPATH") + "dev/" if dev else os.getenv("MODEL_SAVEPATH_BASEPATH")
