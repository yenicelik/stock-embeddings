...
rsync -avzh -P --stats --timeout=60 --exclude=.git --exclude=/.env  --exclude=.idea --exclude=/data --include=/data/processed/all.csv  . grethoma@login.leonhard.ethz.ch:~/deeplearning/
